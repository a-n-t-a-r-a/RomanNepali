...
const consonants = {
  ...
  ha:   "\u0939",   // "ह"
  ksha: "\u0935",   // "क्ष"
  tra:  "त्र",        // combination of त	\u0924, ्	\u094D and ञ \u091E
  gyna: "ज्ञ"         // combination of ज	\u091C, ्	\u094D and ञ \u091E
}

const halntaConsonants = {
  k:   "क्",
  kh:  "ख्",
  g:   "ग्",
  gh:  "घ्",
...
const getCodes = function() {
  ...
  for (let conso in consonants) {
    let newRoman = conso.replace("a", "");
    let code = consonants[conso];
    unicodes[newRoman] = code + dependentVowelSigns["--"];

    for (let dep in dependentVowelSigns) {
      unicodes[newRoman + dep] = code + dependentVowelSigns[dep];
    }
  }
